...
1. エクスプローラーで D ドライブを開くと、 project_allegromoltov_ai/data/arrays フォルダーができているので、その中に、次のリンク先の arrays フォルダー内にある fft_log_normalized.npy と clips.npy をコピーしてきます。 https://1drv.ms/u/s!AnNGKzbxk33_5i_jtm0-o5HaVgI9?e=7Si7nE
