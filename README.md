...
1. /data/out に out_xxxxxx_1.wav, out_xxxxxx_2.wav, out_xxxxxx_3.wav が出力されます。チェックボックスにチェックを入れ Download ボタンを押してダウンロードしてもよいですが、 ローカルの project-allegromolto-am フォルダーの、 out フォルダーの中にあるので、それを直接再生すれば OK です。
