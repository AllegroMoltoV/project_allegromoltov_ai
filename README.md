...
あれぐろもると楽曲風の短い音楽を AI に作ってもらうプロジェクト
...
1. /data/out に out_xxxxxx_track0.wav, ~ out_xxxxxx_track9.wav が出力されます。チェックボックスにチェックを入れ Download ボタンを押してダウンロードしてもよいですが、 ローカルの project_allegromolto_am フォルダーの、 out フォルダーの中にあるので、それを直接再生すれば OK です。
